		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#netphplaunchpadlaunchpad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"netphplaunchpadlaunchpad-display": {
								"semanticObject": "netphplaunchpadlaunchpad",
								"action": "display",
								"description": "Fiori launchpad",
								"title": "Fiori launchpad",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=net.php.launchpad.launchpad",
									"url": sap.ui.require.toUrl("net/php/launchpad/launchpad")
								}
							}
						}
					}
